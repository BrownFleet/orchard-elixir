...
export default function ProductsPage() {
  ...
  const handleFiltersChange = (filters: FilterState) => {
    ...
    filtered = filtered.filter(
      (product) => product.price_eur >= filters.priceRange[0] && product.price_eur <= filters.priceRange[1],
    )
    ...
    <div className="min-h-screen">
      ...
      <main className="container px-4 py-8">
        ...
        <div className="space-y-4 mb-8">
          <h1 className="text-3xl md:text-4xl font-bold text-balance">Our Products</h1>
          <p className="text-lg text-muted-foreground max-w-2xl text-pretty">
            Discover our complete collection of premium essential oils, herbs, and signature blends.
          </p>
        </div>
