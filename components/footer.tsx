      ...
      <div className="container px-4 py-16 lg:py-20 relative z-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="space-y-6 sm:col-span-2 lg:col-span-1">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-2xl font-bold font-serif royal-gradient-text">Orchard Elixir</span>
            </div>
            <p className="text-[#f8f6f0]/80 text-pretty leading-relaxed responsive-text-sm">
              Premium cold-pressed essential oils and herbs for the discerning wellness enthusiast. Crafted with luxury
              and purity in mind.
            </p>
          ...
          <div className="space-y-6">
            <h3 className="responsive-text-lg font-semibold font-serif royal-gradient-text">Quick Links</h3>
          ...
          {/* Customer Care */}
          <div className="space-y-6">
            <h3 className="responsive-text-lg font-semibold font-serif royal-gradient-text">Customer Care</h3>
            <div className="space-y-3">
              <Link
                href="/about"
                className="block text-[#f8f6f0]/80 hover:text-[#d4af37] transition-all duration-300 responsive-text-sm hover:translate-x-1"
          ...
          {/* Contact & Newsletter */}
          <div className="space-y-6 sm:col-span-2 lg:col-span-1">
            <h3 className="responsive-text-lg font-semibold font-serif royal-gradient-text">Stay Connected</h3>
            <div className="space-y-4">
              <div className="flex items-center space-x-3 text-[#f8f6f0]/80">
                <Mail className="h-5 w-5 text-[#d4af37] flex-shrink-0" />
                <span className="responsive-text-sm break-all">hello@orchardelixir.com</span>
              </div>
              <div className="flex items-center space-x-3 text-[#f8f6f0]/80">
            ...
            <div className="space-y-4">
              <p className="responsive-text-sm text-[#f8f6f0]/80 font-medium">Subscribe to our newsletter</p>
        ...
        <div className="border-t border-[#d4af37]/20 mt-12 lg:mt-16 pt-8 text-center">
          <p className="text-[#f8f6f0]/60 responsive-text-sm">
            ...
            <Link href="/privacy" className="hover:text-[#d4af37] transition-colors ml-1">
              Privacy Policy
            </Link>{" "}
            |
            <Link href="/terms" className="hover:text-[#d4af37] transition-colors ml-1">
              Terms of Service
            </Link>
          </p>
        </div>
